...
})(this, this.document); /*VelocityJS.org (1.5.0)*/
!(function (a) {
  "use strict";
  function b(a) {
    var b = a.length,
...
(function (factory) {
  ...
  return (function (global, window, document, undefined) {
    ...
    Velocity.RegisterEffect = Velocity.RegisterUI = function (
      ...
      function animateParentHeight(
        ...
        $.each(
          ...
          function (i, element) {
            ...
            if (
              Velocity.CSS.getPropertyValue(element, "boxSizing")
                .toString()
      ...
      Velocity.Redirects[effectName] = function (
        element,
        redirectOptions,
        elementsIndex,
        elementsSize,
        ...
        for (
          var callIndex = 0;
          callIndex < properties.calls.length;
          callIndex++
        ) {
        ...
        for (callIndex = 0; callIndex < properties.calls.length; callIndex++) {
          ...
          opts.duration =
            redirectDuration *
            (typeof durationPercentage === "number"
              ? durationPercentage
              : shareDuration);
          ...
          if (callIndex === 0) {
            ...
            if (redirectOptions.display !== null) {
              if (
                redirectOptions.display !== undefined &&
                redirectOptions.display !== "none"
              ) {
                ...
                opts.display =
                  defaultDisplay === "inline" ? "inline-block" : defaultDisplay;
              }
            }
            if (
              redirectOptions.visibility &&
              redirectOptions.visibility !== "hidden"
            ) {
    ...
    Velocity.RegisterEffect.packagedEffects = {
      ...
      "transition.bounceUpIn": {
        ...
        calls: [
          [
            { opacity: [1, 0], translateY: [-30, 1000] },
            0.6,
            { easing: "easeOutCirc" },
          ],
          [{ translateY: 10 }, 0.2],
      ...
      "transition.slideUpBigIn": {
        defaultDuration: 850,
        calls: [[{ opacity: [1, 0], translateY: [0, 150], translateZ: 0 }]],
      },
      "transition.slideUpBigOut": {
        defaultDuration: 800,
        calls: [[{ opacity: [0, 1], translateY: -150, translateZ: 0 }]],
        reset: { translateY: 0 },
      },
      ...
      "transition.slideLeftBigIn": {
        defaultDuration: 800,
        calls: [[{ opacity: [1, 0], translateX: [0, -150], translateZ: 0 }]],
      },
      "transition.slideLeftBigOut": {
        defaultDuration: 750,
        calls: [[{ opacity: [0, 1], translateX: -150, translateZ: 0 }]],
        reset: { translateX: 0 },
      },
      ...
      if (sequence.length > 1) {
        $.each(sequence.reverse(), function (i, currentCall) {
          ...
          if (nextCall) {
            ...
            var timing =
                currentCallOptions && currentCallOptions.sequenceQueue === !1
                  ? "begin"
                  : "complete",
            ...
            options[timing] = function () {
              ...
              var elements = nextCallElements.nodeType
                ? [nextCallElements]
                : nextCallElements;
              if (callbackOriginal) {
...
(function (t, e) {
  ...
  function p(t) {
    for (
      var e = ["", "webkit"], a = t.charAt(0).toUpperCase() + t.slice(1), o = 0;
      o < e.length;
      o++
    ) {
      var i = e[o],
  ...
  function s(t, e, a) {
    ...
    if ((r.setAttribute("class", "tippy-content"), a.arrow)) {
      ...
      (s.style[p("transform")] = a.arrowTransform),
        "round" === a.arrowType
          ? (s.classList.add("tippy-roundarrow"),
            (s.innerHTML =
    ...
    if (d) {
      ...
      d instanceof Element
        ? (r.appendChild(d), (c = "#" + (d.id || "tippy-html-template")))
        : ((r.innerHTML = document.querySelector(d).innerHTML), (c = d)),
  ...
  function w(t) {
    ...
    for (
      var e = g(10) ? document.body : null, a = t.offsetParent;
      a === e && t.nextElementSibling;

    )
      a = (t = t.nextElementSibling).offsetParent;
    var i = a && a.nodeName;
    return i && "BODY" !== i && "HTML" !== i
      ? -1 !== ["TD", "TABLE"].indexOf(a.nodeName) &&
        "static" === b(a, "position")
        ? w(a)
        : a
      : t
  ...
  function A() {
    ...
    return { height: O("Height", t, e, a), width: O("Width", t, e, a) };
  }
  function C(t) {
  ...
  function Y(t, e) {
    ...
    a &&
      "HTML" === e.nodeName &&
      ((p.top = Ut(p.top, 0)), (p.left = Ut(p.left, 0)));
    var c = C({
      top: r.top - p.top - l,
    ...
    return (
      (i && !a ? e.contains(n) : e === n && "BODY" !== n.nodeName) &&
        (c = T(c, e)),
      c
    );
  }
  ...
  function X(t) {
    var e = t.nodeName;
    return (
      "BODY" !== e && "HTML" !== e && ("fixed" === b(t, "position") || X(u(t)))
    );
  }
  function I(t) {
  ...
  function D(t, e, a, i) {
    ...
    if ("viewport" === i) r = P(p, o);
      ...
      "scrollParent" === i
        ? ((n = y(u(e))),
          "BODY" === n.nodeName && (n = t.ownerDocument.documentElement))
        : "window" === i
  ...
  function Q(t, e, a, i) {
    (a.updateBound = i),
      G(t).addEventListener("resize", a.updateBound, { passive: !0 });
    var o = y(t);
    return (
      V(o, "scroll", a.updateBound, a.scrollParents),
      (a.scrollElement = o),
      (a.eventsEnabled = !0),
      a
    );
  ...
  function Z(t, e) {
    return (
      G(t).removeEventListener("resize", e.updateBound),
  ...
  function pt(t, e, a, i) {
    ...
    if ("vh" === p || "vw" === p) {
      ...
      return (
        (l =
          "vh" === p
            ? Ut(document.documentElement.clientHeight, window.innerHeight || 0)
            : Ut(document.documentElement.clientWidth, window.innerWidth || 0)),
        (l / 100) * r
      );
    }
    return r;
      ...
      l =
        -1 === n
          ...
          : [
              ...
              [p[n].split(s)[1]].concat(p.slice(n + 1)),
            ];
    return (
    ...
    var i = ct(t),
      ...
      c = a
        .replace(
          l.translate,
          "translate" +
            ht(d.translate.axis, o) +
            "(" +
            ft("translate", d.translate.numbers, o, r) +
            ")"
        )
        .replace(
          l.scale,
  ...
  function Et() {
    ...
    return (
      this.options.followCursor && !qt.usingTouch && t && "focus" !== t.type
    );
  }
  function Tt(t) {
    ...
    if (e && !e._tippy) {
      ...
      a &&
        ...
        Ht(e, Jt({}, this.options, { target: null })),
        Lt.call(e._tippy, t));
    }
  }
  function Lt(t) {
    ...
    if ((Yt.call(this), !this.state.visible)) {
      ...
      if (((this._(be).isPreparingToShow = !0), a.wait))
      ...
      if (Et.call(this)) {
        ...
        o && (o.style.margin = "0"),
          document.addEventListener(
            "mousemove",
            this._(be).followCursorListener
          );
      }
      var r = wt(a.delay, 0);
      r
        ? (this._(be).showTimeout = setTimeout(function () {
            e.show();
          }, r))
        : this.show();
    }
  ...
  function Ot() {
    ...
    if ((Yt.call(this), !!this.state.visible)) {
      ...
      e
        ? (this._(be).hideTimeout = setTimeout(function () {
  ...
  function St(t) {
    ...
    if (
      (this.popperInstance
        ...
        : ((this.popperInstance = Ct.call(this)),
  ...
  function _t(t, e) {
    return t.reduce(function (t, a) {
      ...
      o.createPopperInstanceOnInit &&
        ((n.popperInstance = Ct.call(n)),
        n.popperInstance.disableEventListeners());
      var h = At.call(n);
      return (
        (n.listeners = o.trigger
          .trim()
          .split(" ")
          .reduce(function (t, e) {
        ...
        o.dynamicTitle &&
          It.call(n, {
            ...
            callback: function () {
              ...
              i &&
                ((e[o.allowTitleHTML ? "innerHTML" : "textContent"] = n.title =
                  i),
                f(a));
            },
  ...
  var Mt = Math.min,
    ...
    qt = {};
  zt &&
    ((qt.supported = "requestAnimationFrame" in window),
  ...
  for (
    var jt = {
      ...
      Gt = qt.supported && Object.keys(Kt),
      Vt = function (t, e) {
        if (!(t instanceof e))
    ...
    (me.Defaults = {
      ...
      modifiers: {
        ...
        arrow: {
          ...
          fn: function (t, e) {
            ...
            return (
              (x = Ut(Mt(p[l] - h, x), 0)),
              (t.arrowElement = i),
              (t.offsets.arrow = ((a = {}), ne(a, c, Bt(x)), ne(a, m, ""), a)),
              t
            );
          },
          element: "[x-arrow]",
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            var p = void 0 === r ? e.gpuAcceleration : r,
              ...
              b = void 0;
            if (
              ((b = "bottom" == c ? -s.height + d.bottom : d.top),
            ...
            return (
              (t.attributes = se({}, g, t.attributes)),
        ...
        applyStyle: {
          ...
          fn: function (t) {
            return (
              et(t.instance.popper, t.styles),
              at(t.instance.popper, t.attributes),
              t.arrowElement &&
                Object.keys(t.arrowStyles).length &&
                et(t.arrowElement, t.arrowStyles),
              t
            );
          },
          onLoad: function (t, e, a, i, o) {
            ...
            return (
              ...
              et(e, { position: a.positionFixed ? "fixed" : "absolute" }),
              a
            );
          },
                ...
                return (o.dynamicTitle &&
                  ...
                  ? void (o.onShow.call(a, this),
                    ...
                    St.call(this, function () {
                      if (e.state.visible) {
                        if (
                          (Et.call(e) || e.popperInstance.scheduleUpdate(),
                          Et.call(e))
                        ) {
                  ...
                  yt(function () {
                    Dt.call(e, t, function () {
                      e.state.visible ||
                        ...
                        (!e._(be).isPreparingToShow &&
                          (document.removeEventListener(
                            "mousemove",
                            e._(be).followCursorListener
                          ),
      ...
      return (
        ...
        (k.render = function (a, b, c) {
          ...
          var d,
            ...
            w = this._cycle;
          if (
            (o !== this._time && (a += this._time - o), a >= p - 1e-7 && a >= 0)
          )
            this._locked ||
            ...
            if (
              ((a = this._time), a >= o || (this._repeat && w !== this._cycle))
            )
...
jQuery.fn.parallax = function (a, b) {
  ($el = jQuery(this)),
    TweenLite.to($el, 0.2, {
      x: -((b.clientX - window.innerWidth / 2) / a),
      y: -((b.clientY - window.innerHeight / 2) / a),
    });
}; /*! ScrollMagic v2.0.6*/
!(function (e, t) {
  "function" == typeof define && define.amd
...
!(function (a) {
  "use strict";
  function t(a, r) {
    var t = a.parents("section.elementor-element");
    if (t.find(".animate-general").length) {
      a.find(".animate-general").each(function () {
        var a = r(this);
        if (!a.hasClass("animation-done"))
          if (a.find(".animated-columns").length) {
            var t = r(".animated-columns", this);
            a.data("animate-delay");
            a.find(".animated-columns").each(function () {
              r(this).hasClass("animation-done") || r(this).css("opacity", "0");
            });
          } else {
            (t = r(this)).data("animate-delay");
            t.data("animate-item")
              ? t.find(t.data("animate-item")).each(function () {
                  r(this).hasClass("animation-done") ||
                    r(this).css("opacity", "0");
                })
              : t.css("opacity", "0");
          }
      });
      r(".call-on-waypoint").each(function () {
        var a = r(this);
        a.waypoint(
          function () {
            a.trigger("on-waypoin");
          },
        ...
        a.find(".animate-general").each(function () {
          var t,
            a = r(this),
            n = r(this).data("id");
          if ("stagger" == a.data("animate-columns")) {
            var e = r(".animated-columns", this),
              i = a.data("animate-stagger"),
              o = a.data("animate-delay"),
              s = a.data("animate-out-delay"),
              d = a.data("animate-duration"),
              l = a.data("animate-out-duration"),
              m = a.data("animate-type"),
              u = a.data("animate-out-type"),
              c = a.data("animate-offset");
            a.css("opacity", "1"),
              (t = a.find(".animated-columns")),
              a.waypoint(
                function (a) {
                  "down" === a
                    ? t.hasClass("animation-done") ||
                      t
                        .addClass("animation-done")
                        .removeClass("animation-out-done")
                        .velocity(m, {
                          delay: o,
                          duration: d,
                          display: "auto",
                    ...
                    : "up" !== a ||
                      "" == u ||
                      null == u ||
                      t.hasClass("animation-out-done") ||
                      t
                        .addClass("animation-out-done")
              ...
              t &&
                r("head").append(
                  "<style type='text/css'>." +
                    n +
                    " .animated-columns.animation-done{opacity:1;}</style>"
                );
          } else if ("columns" == a.data("animate-columns")) {
            (e = r(".animated-columns", this)),
              (o = a.data("animate-delay")),
              (s = a.data("animate-out-delay")),
              (m = a.data("animate-type")),
              (u = a.data("animate-out-type")),
              ...
              (l = a.data("animate-out-duration"));
            a.css("opacity", "1"),
              (t = a.find(".animated-columns")).each(function () {
                var t = r(this);
                t.waypoint(
                  function (a) {
                    "down" === a
            ...
            (o = (e = r(this)).data("animate-delay")),
              (s = e.data("animate-out-delay")),
              (d = e.data("animate-duration")),
              (l = a.data("animate-out-duration"));
            (m = e.data("animate-type")),
              (u = e.data("animate-out-type")),
              (c = e.data("animate-offset")),
              e.waypoint(
                function (a) {
                  "down" === a
                    ? e.hasClass("animation-done") ||
                      e
                        .addClass("animation-done")
                        .removeClass("animation-out-done")
                        .velocity(m, { delay: o, duration: d, display: "auto" })
                    : "up" !== a ||
                      "" == u ||
                      null == u ||
                      e.hasClass("animation-out-done") ||
                      e.hasClass("animation-out-done") ||
                      e
                        .addClass("animation-out-done")
                        .removeClass("animation-done")
    ...
    if (
      (t.find(".magic-scroll").length && pt_plus_animateParalax(),
      0 < t.find(".pt-plus-move-parallax").length && plus_mousemove_parallax(),
      0 < t.find(".cascading-block").length && cascading_overflow(),
      0 < t.find(".slide_show_image").length && cascading_slide_show_image(),
      0 < t.find(".pt-plus-cd-headline").length && plus_heading_animation(),
      0 < t.find(".creative-simple-img-parallax").length &&
        plus_bgimage_scrollparallax(),
      0 < t.find(".pt_plus_row_bg_animated_svg").length &&
        r(document).ready(function () {
          setTimeout(function () {
            r(".pt_plus_row_bg_animated_svg").pt_plus_animated_svg(),
              r("body")
                .find(".pt_plus_row_bg_animated_svg")
                .attr("style", "stroke:black");
          }, 100);
        }),
      (0 < t.find(".pt_plus_animated_svg").length ||
        0 < t.find(".ts-hover-draw-svg").length) &&
        r(document).ready(function () {
          setTimeout(function () {
            r(
              ".pt_plus_animated_svg,.ts-hover-draw-svg"
            ).pt_plus_animated_svg();
          }, 100);
        }),
      0 < t.find(".list-isotope-metro").length)
    ) {
      var n = t.find(".list-isotope-metro"),
        e = n.data("id"),
        i = n.attr("data-metro-columns"),
        o = n.attr("data-metro-style");
      theplus_backend_packery_portfolio(e, i, o);
    }
    if (0 < t.find(".list-carousel-slick").length) {
      var s = a.find(".list-carousel-slick").eq(0);
      0 < s.length && (s.hasClass("done-carousel") || theplus_carousel_list());
    }
    t.find(".theplus-contact-form").length && plus_cf7_form(),
      0 < t.find("iframe").length &&
        "undefined" != typeof initFluidVids &&
        r.isFunction(initFluidVids) &&
        initFluidVids(),
      t.find(".js-tilt").length && r(".js-tilt").tilt(),
      t.find(".pt-plus-reveal").length && plus_reveal_animation(),
      t.find(".columns-vimeo-bg").length &&
        r(".columns-vimeo-bg iframe").each(function () {
          var n = r(this);
          function a(a) {
            switch (JSON.parse(a.data).event) {
              case "ready":
                ...
                var t = document.getElementById("wrapper-" + id);
                t && t.id && t.classList.remove("tp-loading");
            }
          }
          (id = n.attr("id")),
        ...
        a(".animate-general").each(function () {
          ...
          if ("stagger" == g.data("animate-columns")) {
            ...
            var i = a(this),
              ...
              n = g.data("animate-out-duration");
            (f = i.data("animate-type")),
              (p = i.data("animate-out-type")),
              (q = i.data("animate-offset")),
              i.waypoint(
                function (a) {
                  "down" === a
                    ? !i.hasClass("animation-done") &&
                      i
                        .addClass("animation-done")
                        .removeClass("animation-out-done")
                        .velocity(f, { delay: k, duration: m, display: "auto" })
                    : "up" == a &&
                      "" != p &&
                      p != null &&
                      !i.hasClass("animation-out-done") &&
                      !i.hasClass("animation-out-done") &&
                      i
                        .addClass("animation-out-done")
                        .removeClass("animation-done")
...
function pt_plus_animateParalax() {
  "use strict";
  var a = jQuery;
  if (0 < a("body").find(".magic-scroll").length) {
    var b = new ScrollMagic.Controller();
    a(".magic-scroll").each(function (c, d) {
      var e = "tween-" + c;
      e = new TimelineMax();
      for (
        var f = a(d).find(".parallax-scroll").length,
          g = a(d).find(".parallax-scroll").data("scroll_offset"),
          h = a(d).find(".parallax-scroll").data("scroll_duration"),
          j = 0;
        j < f;
        j++
      ) {
        var k = 0.5,
          l = a(d).find(".parallax-scroll").data("scroll_type"),
          m = a(d).find(".parallax-scroll").data("scroll_x_from"),
          n = a(d).find(".parallax-scroll").data("scroll_x_to"),
          o = a(d).find(".parallax-scroll").data("scroll_y_from"),
          p = a(d).find(".parallax-scroll").data("scroll_y_to"),
          q = a(d).find(".parallax-scroll").data("scroll_opacity_from"),
          r = a(d).find(".parallax-scroll").data("scroll_opacity_to"),
          s = a(d).find(".parallax-scroll").data("scroll_rotate_from"),
          t = a(d).find(".parallax-scroll").data("scroll_rotate_to"),
          u = a(d).find(".parallax-scroll").data("scroll_scale_from"),
          v = a(d).find(".parallax-scroll").data("scroll_scale_to");
        "position" == l &&
          (0 == j
            ? e.fromTo(
                a(d).find(".parallax-scroll:eq(" + j + ")"),
                1,
                {
                  scale: u,
                  rotation: s,
            ...
            : e.to(
                a(d).find(".parallax-scroll:eq(" + j + ")"),
                1,
                { scale: v, y: -(p * k), ease: Linear.easeNone },
                "-=1"
              ));
      }
...
function plus_mousemove_parallax() {
  "use strict";
  var a = jQuery,
    b = a(".pt-plus-move-parallax"),
    c = b.find(".parallax-move");
  0 < b.length &&
    (a(".pt-plus-move-parallax").on("mouseleave", function (b) {
      var c = b.pageX - 0.5 * a(this).width(),
        d = b.pageY - 0.5 * a(this).height();
      a(this)
        .find(".parallax-move")
        .each(function () {
          var b = a(this),
            c = b.data("move_speed_x"),
            d = b.data("move_speed_y");
          TweenLite.to(b, 0.9, { x: 0, y: 0 });
        });
    }),
    b.on("mousemove", function (b) {
      a(this)
        ...
        .each(function () {
          var c = a(this),
            d = c.data("move_speed_x"),
            e = c.data("move_speed_y");
          a(this).parallaxmovecontent(d, e, b);
        });
    }),
    (a.fn.parallaxmovecontent = function (b, c, d) {
      var e = a(this);
      TweenLite.to(e, 0.5, {
        x: -((d.clientX - window.innerWidth / 2) / b),
        y: -((d.clientY - window.innerHeight / 2) / c),
      });
    }));
}
(function (a) {
...
function plus_reveal_animation() {
  "use strict";
  var a = jQuery;
  a(".pt-plus-reveal").each(function () {
    var c = a(this),
      b = c.data("reveal-id"),
      d = c.data("effect-color-1"),
      e = c.data("effect-color-2");
    a("head").append(
      "<style type='text/css'>." +
        b +
...
(function (a) {
  "use strict";
  a(document).ready(function () {
    0 < a(".content_hover_effect").length &&
      a(".content_hover_effect").each(function () {
        var b = a(this),
          c = b.data("hover_uniqid"),
          d = b.data("hover_shadow"),
          e = b.data("content_hover_effects");
        "float_shadow" == e &&
          a("head").append(
            "<style >." +
              c +
              ".content_hover_float_shadow:before{background: -webkit-radial-gradient(center, ellipse, " +
              d +
              " 0%, rgba(60, 60, 60, 0) 70%);background: radial-gradient(ellipse at center, " +
              d +
              " 0%, rgba(60, 60, 60, 0) 70%);}</style>"
          ),
          "shadow_radial" == e &&
            a("head").append(
              "<style >." +
                c +
                ".content_hover_radial:after{background: -webkit-radial-gradient(50% -50%, ellipse, " +
                d +
                " 0%, rgba(0, 0, 0, 0) 80%);background: radial-gradient(ellipse at 50% -50%, " +
                d +
                " 0%, rgba(0, 0, 0, 0) 80%);}." +
                c +
                ".content_hover_radial:before{background: -webkit-radial-gradient(50% 150%, ellipse, " +
                d +
                " 0%, rgba(0, 0, 0, 0) 80%);background: radial-gradient(ellipse at 50% 150%, " +
                d +
          ...
          "grow_shadow" == e &&
            a("head").append(
              "<style >." +
                c +
                ".content_hover_grow_shadow:hover{-webkit-box-shadow: 0 10px 10px -10px " +
                d +
...
(function ($) {
  ...
  var WidgetHoverTiltHandler = function ($scope, $) {
    ...
    if (wid_sec.find(".hover-tilt").length) {
      $(".hover-tilt").hover3d({
        selector:
          ".blog-list-style-content,> .addbanner-block,> .addbanner_product_box,> .vc_single_image-wrapper,> .cascading-inner-loop,.info-box-bg-box",
        shine: !1,
        invert: !0,
        sensitivity: 20,
      });
...
/*slick carousel*/ (function (a) {
  "use strict";
  var b = function (a) {
    var b = a.parents("section.elementor-element");
    if (0 < b.find(".list-carousel-slick").length) {
      var c = a.find(".list-carousel-slick").eq(0);
      0 < c.length && !c.hasClass("done-carousel") && theplus_carousel_list();
    }
  };
  a(window).on("elementor/frontend/init", function () {
...
function theplus_carousel_list(a = "") {
  var b = jQuery;
  b(".list-carousel-slick").each(function () {
    var c = b(this),
      d = c.data("id"),
      e = c.data("slider_direction"),
      f = c.data("slide_speed"),
      g = c.data("default_active_slide"),
      h = c.data("slider_desktop_column"),
      i = c.data("steps_slide"),
      j = c.data("slide_fade_inout"),
      k = c.data("slider_padding"),
      l = c.data("slider_draggable"),
      m = c.data("multi_drag"),
      n = c.data("slider_infinite"),
      o = c.data("slider_pause_hover"),
      p = c.data("slider_adaptive_height"),
      q = c.data("slider_animation"),
      r = c.data("slider_autoplay"),
      s = c.data("autoplay_speed"),
      t = c.data("slider_rows"),
      u = c.data("slider_center_mode"),
      v = c.data("center_padding"),
      w = c.data("scale_center_slide"),
      x = c.data("scale_normal_slide"),
      y = c.data("opacity_normal_slide"),
      z = c.data("slider_dots"),
      A = c.data("slider_dots_style"),
      B = c.data("slider_arrows"),
      C = c.data("slider_arrows_style"),
      D = c.data("arrows_position"),
      E = c.data("slider_responsive_tablet"),
      F = c.data("slider_tablet_column"),
      G = c.data("tablet_steps_slide"),
      H = c.data("tablet_center_mode"),
      I = c.data("tablet_center_padding"),
      J = c.data("tablet_slider_draggable"),
      K = c.data("tablet_slider_infinite"),
      L = c.data("tablet_slider_autoplay"),
      M = c.data("tablet_autoplay_speed"),
      N = c.data("tablet_slider_dots"),
      O = c.data("tablet_slider_arrows"),
      P = c.data("tablet_slider_rows"),
      H = c.data("tablet_center_mode"),
      I = c.data("tablet_center_padding"),
      Q = c.data("slider_responsive_mobile"),
      R = c.data("mobile_slider_draggable"),
      S = c.data("mobile_slider_infinite"),
      T = c.data("mobile_slider_autoplay"),
      U = c.data("mobile_autoplay_speed"),
      V = c.data("slider_mobile_column"),
      W = c.data("mobile_steps_slide"),
      X = c.data("mobile_center_mode"),
      Y = c.data("mobile_center_padding"),
      Z = c.data("mobile_slider_dots"),
      $ = c.data("mobile_slider_arrows"),
      _ = c.data("mobile_slider_rows"),
      X = c.data("mobile_center_mode"),
      Y = c.data("mobile_center_padding"),
      aa = c.data("testimonial-style"),
      ba = c.data("slide_mouse_scroll"),
      ca = !1;
    if (
      ("rtl" == document.dir && !0 != e && (ca = !0),
      "1" == i ? "1" == i : (i = h),
      "1" == G ? "1" == G : (G = F),
      "yes" != E &&
        ((J = l),
    ...
    if ("style-2" == C)
      var da =
          '<button type="button" class="slick-nav slick-prev ' +
          C +
          '"><span class="icon-wrap"></span></button>',
        ea =
          '<button type="button" class="slick-nav slick-next ' +
          C +
          '"><span class="icon-wrap"></span></button>';
    if ("style-3" == C || "style-4" == C)
      var da =
          '<button type="button" class="slick-nav slick-prev ' +
          C +
          " " +
    ...
    if ("style-6" == C)
      var da =
          '<button type="button" class="slick-nav slick-prev ' +
          C +
          '"><span class="icon-wrap"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></span></button>',
        ea =
          '<button type="button" class="slick-nav slick-next ' +
          C +
          '"><span class="icon-wrap"><i class="fas fa-long-arrow-alt-right" aria-hidden="true"></i></span></button>';
    null == g && (g = 0);
    var fa = {
      dots: z,
      vertical: e,
    ...
    b(this).hasClass("done-carousel") || c.hasClass("theplus-insta-grid")
      ? !b(this).hasClass("done-carousel") &&
        c.hasClass("theplus-insta-grid") &&
        "" != a &&
        "instagram" == a &&
        0 <
          b("." + d + " > .post-inner-loop").find(".theplus-insta-feed")
            .length &&
        (b("> .post-inner-loop", this).slick(fa),
        b(this).addClass("done-carousel"),
        setTimeout(function () {
          b(".slick-dots.style-2 li").each(function () {
            0 == b(this).find("svg").length &&
              b(this).append(
      ...
      : (b("> .post-inner-loop", this).slick(fa),
        ...
        !0 == ba &&
          null != ba &&
          b("." + d + " > .post-inner-loop").mousewheel(function (a) {
            a.preventDefault(),
              0 > a.deltaY
                ? b("." + d + " > .post-inner-loop").slick("slickNext")
                : b("." + d + " > .post-inner-loop").slick("slickPrev");
          }));
    var ga = b(this).data("carousel-bg-conn");
    "" != ga &&
      null != ga &&
      0 < b("#" + ga).length &&
      b("> .post-inner-loop", this).on("beforeChange", function (a, c, d, e) {
        var f = b("#" + ga + " .bg-carousel-slide");
        if ((f.removeClass("bg-active-slide"), f.length > e))
          f.eq(e).addClass("bg-active-slide");
        else {
          var g = f.length;
          f.eq(e % g).addClass("bg-active-slide");
        }
      });
    var ha = b(this).data("connection");
    "" != ha &&
      null != ha &&
      0 < b("#" + ha).length &&
      b("> .post-inner-loop", this).on("beforeChange", function (a, c, d, e) {
        if (
          !b("#" + ha)
            .find('.tp-process-steps-wrapper[data-index="' + parseInt(e) + '"]')
            .hasClass("active")
        ) {
          var f = b("#" + ha).data("eventtype");
          "con_pro_click" == f
            ? b("#" + ha)
                .find(
                  '.tp-process-steps-wrapper[data-index="' + parseInt(e) + '"]'
                )
                .trigger("click")
            : "con_pro_hover" == f &&
              b("#" + ha)
      ...
      ((!0 === u && null != u) ||
        ...
        (b("> .post-inner-loop", this).on(
          ...
          function (a, c, d, e) {
            ...
            (f =
              ...
              "right" == f &&
                b(
                  '.slick-cloned[data-slick-index="' + (e + g + 1) + '"]',
                  this
                ).addClass("scc-animate"),
              "left" == f &&
                b(
                  '.slick-cloned[data-slick-index="' + (e - g - 1) + '"]',
                  this
        ...
        b("> .post-inner-loop", this).on("afterChange", function () {
          b(".scc-animate", this).removeClass("scc-animate"),
            b(".scc-animate", this).removeClass("scc-animate");
        }));
  });
}
function accordion_tabs_connection(a, b) {
  var c = jQuery;
  if ("" != b && 1 == c("." + b).length) {
    var d = c("." + b + " > .post-inner-loop").slick("slickCurrentSlide");
    d != a - 1 && c("." + b + " > .post-inner-loop").slick("slickGoTo", a - 1);
  }
}
/*Metro Layout Load*/ function theplus_backend_packery_portfolio(t, s, i) {
  "use strict";
  var e = jQuery,
    a = e(window),
    h = e("#" + t);
  if ("4" == s) {
    var o = 2 * (m = Math.floor((h.width() - 0) / 4));
    h.find(".grid-item").each(function () {
      var t = m,
        s = m;
      "style-1" == i &&
        ((e(this).hasClass("metro-item3") || e(this).hasClass("metro-item9")) &&
          (s = t = o),
        (e(this).hasClass("metro-item4") || e(this).hasClass("metro-item10")) &&
          ((t = o), (s = m))),
        "style-2" == i &&
          ((e(this).hasClass("metro-item1") ||
            e(this).hasClass("metro-item5") ||
            e(this).hasClass("metro-item9") ||
            e(this).hasClass("metro-item10")) &&
            (s = t = o),
          (e(this).hasClass("metro-item2") ||
            e(this).hasClass("metro-item8")) &&
            ((t = o), (s = m))),
        "style-3" == i &&
          (e(this).hasClass("metro-item5") && ((t = o), (s = m)),
          e(this).hasClass("metro-item1") && ((t = m), (s = o)),
          (e(this).hasClass("metro-item3") ||
            e(this).hasClass("metro-item6")) &&
            (s = t = o)),
        a.width() < 760 && ((t = a.width() - 0), (s = a.width() - 0)),
        e(this).css({ width: t + "px", height: s + "px" });
    });
  }
  if ("5" == s) {
    o = 2 * (m = Math.floor((h.width() - 0) / 5));
    h.find(".grid-item").each(function () {
      var t = m,
        s = m;
      "style-1" == i &&
        ((e(this).hasClass("metro-item5") ||
          e(this).hasClass("metro-item15")) &&
          (s = t = o),
        (e(this).hasClass("metro-item1") ||
          e(this).hasClass("metro-item2") ||
          e(this).hasClass("metro-item9") ||
    ...
    h.find(".grid-item").each(function () {
      ...
      "style-1" == i &&
        ((e(this).hasClass("metro-item1") ||
          ...
          (s = t = o),
        (e(this).hasClass("metro-item2") ||
          e(this).hasClass("metro-item7") ||
          e(this).hasClass("metro-item14") ||
          e(this).hasClass("metro-item15") ||
          e(this).hasClass("metro-item16")) &&
          ((t = o), (s = m)),
        (e(this).hasClass("metro-item4") ||
          e(this).hasClass("metro-item6") ||
          e(this).hasClass("metro-item8")) &&
          ((t = m), (s = o))),
        a.width() < 760 && ((t = a.width() - 0), (s = a.width() - 0)),
      ...
      "style-1" == i
        ? ((e(this).hasClass("metro-item1") ||
          ...
          (e(this).hasClass("metro-item4") ||
            ...
            ((t = o), (s = m)))
        : "style-2" == i
        ? (e(this).hasClass("metro-item2") && ((t = o), (s = m)),
          (e(this).hasClass("metro-item4") ||
            e(this).hasClass("metro-item8")) &&
            ((t = m), (s = o)),
          e(this).hasClass("metro-item7") && (s = t = o))
        : "style-3" == i
        ? ((e(this).hasClass("metro-item4") ||
            e(this).hasClass("metro-item15")) &&
            ((t = o), (s = m)),
          e(this).hasClass("metro-item9") && ((t = m), (s = o)),
          e(this).hasClass("metro-item10") && (s = t = o))
        : "style-4" == i &&
          (e(this).hasClass("metro-item1") && (s = t = o),
          e(this).hasClass("metro-item7") && ((t = o), (s = m))),
        a.width() < 760 && ((t = a.width() - 0), (s = a.width() - 0)),
        e(this).css({ width: t + "px", height: s + "px" });
    });
  }
...
function theplus_setup_packery_portfolio(t) {
  "use strict";
  var r = jQuery;
  r(".list-isotope-metro").each(function () {
    var t = r(this).data("id"),
      s = r(this).attr("data-metro-columns"),
      i = r(this).attr("data-tablet-metro-columns"),
      e = r(window),
      a = window.innerWidth;
    if ((a <= 1024 && null != i && (s = i), "4" == s)) {
      var h = r(this).attr("data-metro-style"),
        o = 2 * (m = Math.floor((r(this).width() - 0) / 4));
      r(this)
        .find(".grid-item")
        .each(function () {
          var t = m,
            s = m;
          "style-1" == h &&
            ((r(this).hasClass("metro-item3") ||
              r(this).hasClass("metro-item9")) &&
              (s = t = o),
            (r(this).hasClass("metro-item4") ||
              r(this).hasClass("metro-item10")) &&
              ((t = o), (s = m))),
            "style-2" == h &&
              ((r(this).hasClass("metro-item1") ||
                r(this).hasClass("metro-item5") ||
                r(this).hasClass("metro-item9") ||
                r(this).hasClass("metro-item10")) &&
                (s = t = o),
              (r(this).hasClass("metro-item2") ||
                r(this).hasClass("metro-item8")) &&
                ((t = o), (s = m))),
            "style-3" == h &&
              (r(this).hasClass("metro-item5") && ((t = o), (s = m)),
              r(this).hasClass("metro-item1") && ((t = m), (s = o)),
              (r(this).hasClass("metro-item3") ||
                r(this).hasClass("metro-item6")) &&
                (s = t = o)),
            e.width() < 760 && ((t = e.width() - 0), (s = e.width() - 0)),
            r(this).css({ width: t + "px", height: s + "px" });
        });
    }
    if ("5" == s) {
      (h = r(this).attr("data-metro-style")),
        (o = 2 * (m = Math.floor((r(this).width() - 0) / 5)));
      r(this)
        .find(".grid-item")
        .each(function () {
          var t = m,
    ...
    if ("6" == s) {
      (h = r(this).attr("data-metro-style")),
        (o = 2 * (m = Math.floor((r(this).width() - 0) / 6)));
      r(this)
        .find(".grid-item")
        .each(function () {
          var t = m,
          ...
          "style-1" == h &&
            ((r(this).hasClass("metro-item1") ||
              ...
              (s = t = o),
            (r(this).hasClass("metro-item2") ||
              r(this).hasClass("metro-item7") ||
              r(this).hasClass("metro-item14") ||
              r(this).hasClass("metro-item15") ||
              r(this).hasClass("metro-item16")) &&
              ((t = o), (s = m)),
            (r(this).hasClass("metro-item4") ||
              r(this).hasClass("metro-item6") ||
              r(this).hasClass("metro-item8")) &&
    ...
    if ("3" == s) {
      h = r(this).attr("data-metro-style");
      a <= 1024 && null != i && (h = r(this).attr("data-tablet-metro-style"));
      var m;
      o = 2 * (m = Math.floor((r(this).width() - 0) / 3));
      r(this)
        .find(".grid-item")
        .each(function () {
          var t = m,
          ...
          "style-1" == h
            ? ((r(this).hasClass("metro-item1") ||
              ...
              (r(this).hasClass("metro-item4") ||
                ...
                ((t = o), (s = m)))
            : "style-2" == h
            ? (r(this).hasClass("metro-item2") && ((t = o), (s = m)),
              (r(this).hasClass("metro-item4") ||
                r(this).hasClass("metro-item8")) &&
                ((t = m), (s = o)),
              r(this).hasClass("metro-item7") && (s = t = o))
            : "style-3" == h
            ? ((r(this).hasClass("metro-item4") ||
                r(this).hasClass("metro-item15")) &&
                ((t = o), (s = m)),
              r(this).hasClass("metro-item9") && ((t = m), (s = o)),
              r(this).hasClass("metro-item10") && (s = t = o))
            : "style-4" == h &&
              (r(this).hasClass("metro-item1") && (s = t = o),
              r(this).hasClass("metro-item7") && ((t = o), (s = m))),
            e.width() < 760 && ((t = e.width() - 0), (s = e.width() - 0)),
            r(this).css({ width: t + "px", height: s + "px" });
        });
    }
    r(this).hasClass("list-isotope-metro")
      ? 767 < e.innerWidth()
        ? r("#" + t).isotope({
            itemSelector: ".grid-item",
            layoutMode: "masonry",
...
!(function (e) {
  ...
  e(document).ready(function () {
    e(".list-isotope-metro").each(function () {
      var t = e(this).data("id"),
        i = e("." + t).find(".post-inner-loop");
      e("." + t + " .post-filter-data")
        .find(".filter-category-list")
        .on("click", function (t) {
          t.preventDefault();
          var s = e(this).attr("data-filter");
          e(this).parent().parent().find(".active").removeClass("active"),
            e(this).addClass("active"),
            i.isotope({ filter: s, visibleStyle: { opacity: 1 } }),
            e("body").trigger("isotope-sorted");
        });
    }),
      0 < e(".list-isotope-metro").length &&
        (theplus_setup_packery_portfolio("all"),
        e(".list-isotope-metro .post-inner-loop")
          .isotope("layout")
          .isotope("reloadItems"));
  }),
    e(window).on("resize", function () {
      0 < e(".list-isotope-metro").length &&
        (theplus_setup_packery_portfolio("all"),
        e(".list-isotope-metro .post-inner-loop").isotope("layout"));
    });
})(jQuery);
/*equal height*/ (function (a) {
  (a.fn.equalHeights = function () {
    var b = 0;
    a(this).each(function () {
      b = Math.max(a(this).outerHeight(), b);
    }),
      a(this).each(function () {
    ...
    a(document).ready(function () {
      var b = a(".elementor-element[data-tp-equal-height-loadded]");
      b.length &&
        b.each(function () {
          var b = a(this).data("id"),
            c = a(this).data("tp-equal-height-loadded");
          a(".elementor-element-" + b + " " + c).equalHeights();
        });
    }),
...
/*accordion*/ (function (a) {
  "use strict";
  var b = function (a, b) {
    var c = a.find(".theplus-accordion-wrapper"),
      d = c,
      e = d.attr("id"),
      f = b("#" + e),
      g = d.data("accordion-type"),
      h = d.data("toogle-speed"),
      i = d.find(".theplus-accordion-item"),
      j = i.find(".plus-accordion-header");
    i.each(function () {
      if (b(this).find(j).hasClass("active-default")) {
        b(this).find(j).addClass("active"),
          b(this)
            .find(".plus-accordion-content")
            .addClass("active")
            .css("display", "block")
            .slideDown(h);
        var a = b(this)
          .closest(".theplus-accordion-wrapper")
          .data("connection");
        if ("" != a && a != null) {
          var c = b(this).find(".plus-accordion-content.active").data("tab");
          b("." + a).length &&
            setTimeout(function () {
              accordion_tabs_connection(c, a);
            }, 150);
        }
        b(this)
          .next(".plus-accordion-content")
          .find(" .list-carousel-slick > .post-inner-loop").length &&
          b(this)
            .next(".plus-accordion-content")
            .find(" .list-carousel-slick > .post-inner-loop")
            .slick("setPosition");
        var d = b(this)
          .closest(".theplus-accordion-wrapper")
          .data("row-bg-conn");
        if ("" != d && d != null && b("#" + d).length) {
          var c = b(this).find(".plus-accordion-content.active").data("tab");
          background_accordion_tabs_conn(c, d);
        }
      }
    }),
      "accordion" == g &&
        j.on("click", function () {
          if (b(this).hasClass("active"))
            ...
            var a = b(this)
              ...
              .data("connection");
            if ("" != a && a != null) {
              var c = b(this).data("tab");
              b("." + a).length && accordion_tabs_connection(c, a);
            }
            var d = b(this)
              .closest(".theplus-accordion-wrapper")
              .data("row-bg-conn");
    ...
    "" != k &&
      ...
      !b(k).hasClass("active") &&
      b(k).length &&
      (b("html, body").animate({ scrollTop: b(k).offset().top }, 1500),
      b(k + ".plus-accordion-header").trigger("click"));
  };
  a(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-accordion.default",
      b
    );
  });
})(jQuery);
/*posts listing*/ (function (a) {
  "use strict";
  var b = function (a, g) {
    a.parents("section.elementor-element");
    if (a.hasClass("elementor-widget") && 0 < a.find(".list-isotope").length) {
      var d = window.theplus || {};
      (d.window = g(window)),
        (d.document = g(document)),
        (d.windowHeight = d.window.height()),
        (d.windowWidth = d.window.width()),
        (d.list_isotope_Posts = function () {
          var b = function () {
            g(".list-isotope", a).each(function () {
              var a,
                b = g(this),
                c = b.data("layout-type"),
                d = {
                  itemSelector: ".grid-item",
                  resizable: !0,
                ...
                f = b.data("id"),
                h = g("." + f).find(".post-inner-loop");
              g("." + f).addClass("pt-plus-isotope layout-" + c),
                (a = "masonry" === c ? "packery" : "fitRows"),
                (d.layoutMode = a),
                (function () {
                  var a = h.isotope(d);
                  a.imagesLoaded().progress(function () {
                    ...
                    h.removeClass("tp-listing-preloader");
                })();
            });
          };
          0 < a.find(".list-isotope .post-filter-data").length &&
            g(".list-isotope .post-filter-data")
              .find(".filter-category-list")
              .on("click", function (a) {
                a.preventDefault();
                var b = g(this).closest(".list-isotope"),
                  c = b.data("id"),
                  e = g(this).attr("data-filter");
                g(this).parent().parent().find(".active").removeClass("active"),
                  g(this).addClass("active"),
                  g("." + c)
                    .find(".post-inner-loop")
                    .isotope({ filter: e }),
                  g("body").trigger("isotope-sorted");
              }),
            d.window.on("resize", function () {
              b('[data-enable-isotope="1"]');
            }),
            d.document.on("load resize", function () {
              b('[data-enable-isotope="1"]');
            }),
            g(document).ready(function () {
              b('[data-enable-isotope="1"]');
            }),
            g("body").on("post-load resort-isotope", function () {
              setTimeout(function () {
                b('[data-enable-isotope="1"]');
              }, 800);
            }),
            g("body").on("tabs-reinited", function () {
              setTimeout(function () {
                b('[data-enable-isotope="1"]');
              }, 800);
            });
        ...
        (d.init = function () {
          d.list_isotope_Posts();
        }),
        d.init();
    }
    a.hasClass("elementor-widget") &&
      0 < a.find(".list-isotope-metro").length &&
      (g(window).on("resize", function () {
        theplus_setup_packery_portfolio("all"),
          g(".list-isotope-metro .post-inner-loop")
            .isotope("layout")
            .isotope("reloadItems");
      }),
      g("body").on("post-load resort-isotope", function () {
        setTimeout(function () {
          theplus_setup_packery_portfolio("all"),
            g(".list-isotope-metro .post-inner-loop").isotope("layout");
        }, 800);
      }),
      g("body").on("tabs-reinited", function () {
        setTimeout(function () {
      ...
      a.hasClass("elementor-widget") &&
        0 < a.find(".gallery-list.gallery-style-3").length &&
        g(".gallery-list.gallery-style-3 .grid-item").each(function () {
          g(this).hoverdir();
        }),
      a.hasClass("elementor-widget") &&
        0 <
          a.find(
            ".dynamic-listing.dynamic-listing-style-1,.blog-list.blog-style-1,.gallery-list.gallery-style-2"
          ).length &&
        g(document).ready(function (a) {
          a(document).on(
            "mouseenter",
            ".dynamic-listing.dynamic-listing-style-1 .grid-item .blog-list-content,.blog-list.blog-style-1 .grid-item .blog-list-content,.gallery-list.gallery-style-2 .grid-item .gallery-list-content",
            function () {
              a(this).find(".post-hover-content").slideDown(300);
            }
          ),
            a(document).on(
              "mouseleave",
              ".dynamic-listing.dynamic-listing-style-1 .grid-item .blog-list-content,.blog-list.blog-style-1 .grid-item .blog-list-content,.gallery-list.gallery-style-2 .grid-item .gallery-list-content",
              function () {
                a(this).find(".post-hover-content").slideUp(300);
              }
            );
        });
  };
...
(function (f) {
  ...
  f(document).ready(function () {
    0 < f(".post-load-more").length &&
      f(document).on("click", ".post-load-more", function (b) {
        b.preventDefault();
        var e = f(this),
          g = f(this),
          a = g.attr("data-page") || 1,
          h = g.data("total_page"),
          i = g.data("load-class"),
          j = g.data("layout"),
          k = g.data("loadattr"),
          l = g.data("offset-posts"),
          m = g.data("display_post"),
          n = g.data("post_load_more"),
          o = g.text(),
          q = g.data("loaded_posts"),
          r = g.data("tp_loading_text");
        if (!e.data("requestRunning"))
          if (
            ...
            var s = parseInt(a - 1) * parseInt(n) + parseInt(m) + parseInt(l);
            f.ajax({
              type: "POST",
              data:
                "action=theplus_more_post&offset=" +
                s +
                "&paged=" +
                a +
                "&loadattr=" +
              ...
              success: function (g) {
                if ("" == g) f(e).addClass("hide");
                else {
                  if (
                    (f("." + i + " .post-inner-loop").append(g),
                    ("grid" == j || "masonry" == j) &&
                      !f("." + i).hasClass("list-grid-client"))
                  ) {
                    var k = f("");
                    f("." + i + " .post-inner-loop").isotope("insert", k),
                      f("." + i + " .post-inner-loop")
                        .isotope("layout")
                        .isotope("reloadItems");
                  }
                  if (
                    0 <
                    f("." + i + ".list-isotope-metro .post-inner-loop").length
                  ) {
                    var l = f("." + i),
                      m = l.data("id"),
                      n = l.attr("data-metro-columns"),
                      r = l.attr("data-metro-style");
                    theplus_backend_packery_portfolio(m, n, r),
                      f("." + i + ".list-isotope-metro .post-inner-loop")
                        .isotope("layout")
                        .isotope("reloadItems");
                  }
                  if (f("." + i).parents(".animate-general").length) {
                    var s, t;
                    if (f("." + i).find(".animated-columns").length) {
                      var u = f("." + i).parents(".animate-general"),
                        p = u.data("animate-delay"),
                        v = u.data("animate-stagger"),
                        t = u.data("animate-type"),
                        w = u.data("animate-offset");
                      u.css("opacity", "1"),
                        (s = u.find(".animated-columns")),
                        s.each(function () {
                          var a = f(this);
                          a.waypoint(
                            function (b) {
                              "down" !== b ||
                                a.hasClass("animation-done") ||
                                a
                                  .addClass("animation-done")
                                  .velocity(t, { delay: p, display: "auto" });
                            },
                            { triggerOnce: !0, offset: w }
                          );
                        });
                    } else {
                      var x = f("." + i).parents(".animate-general"),
                        p = x.data("animate-delay");
                      (t = x.data("animate-type")),
                        (w = x.data("animate-offset")),
                        x.waypoint(
                          function (a) {
                            "down" !== a ||
                              x.hasClass("animation-done") ||
                              x
                                .addClass("animation-done")
                                .velocity(t, { delay: p, display: "auto" });
                          },
                ...
                a++,
                  a == h
                    ? (f(e).addClass("hide"),
                      f(e).attr("data-page", a),
                      f(e)
                        .parent(".ajax_load_more")
                        .append(
                          '<div class="plus-all-posts-loaded">' + q + "</div>"
                        ))
                    : (f(e).text(o), f(e).attr("data-page", a));
                var b = f("." + i + " .post-inner-loop").find(
              ...
              complete: function () {
                if (
                  (f("." + i + " .post-filter-data").length &&
                    f(
                      "." + i + " .post-filter-data .category-filters > li > a"
                    ).each(function () {
                      var a = f(this).data("filter");
                      if ("" != a && null != a && "*" === a)
                        var b = f(
                          "." + i + " .post-inner-loop .grid-item"
                        ).length;
                      else if ("" != a && null != a)
                        var b = f(
                          "." + i + " .post-inner-loop .grid-item" + a
                        ).length;
                      b && f(this).find(".all_post_count").text(b);
                    }),
                  f(
                    ".elementor-widget-tp-row-background .elementor-widget-container"
                  ).each(function () {
                    var a = f(this).html();
                    f(this).closest(".elementor-section").prepend(a),
                      f(this).remove();
                  }),
                  ("grid" != j && "masonry" != j) ||
                    f("." + i).hasClass("list-grid-client") ||
                  ...
                  var a = f("." + i),
                    b = a.data("id"),
                    c = a.attr("data-metro-columns"),
                    d = a.attr("data-metro-style");
                  theplus_backend_packery_portfolio(b, c, d),
                    f("." + i + ".list-isotope-metro .post-inner-loop")
                      .isotope("layout")
                      .isotope("reloadItems");
                }
                e.data("requestRunning", !1);
              },
            }).then(function () {
              if (
                !f("." + i).hasClass("list-grid-client") &&
                ...
                var a = f("." + i + " .post-inner-loop");
                a.isotope({ itemSelector: ".grid-item" });
              }
              if (
                0 < f("." + i + ".list-isotope-metro .post-inner-loop").length
              ) {
                var a = f("." + i),
                  b = a.data("id"),
                  c = a.attr("data-metro-columns"),
...
(function (f) {
  ...
  f(window).on("load", function () {
    if (1 <= f("body").find(".post-lazy-load").length) {
      var a,
        b,
        c,
        d,
        ...
        i = function () {
          (a = h.width()),
            (b = h.height()),
            (c = f("body").height()),
            (e = f(".list-isotope,.list-isotope-metro").height()),
            (g = f(".list-isotope,.list-isotope-metro").offset().top + 50),
            setTimeout(function () {
              (e = f(".list-isotope,.list-isotope-metro").height()),
                (g = f(".list-isotope,.list-isotope-metro").offset().top + 50);
            }, 50);
      ...
      i(),
        ...
        h.bind("scroll", function (a) {
          a.preventDefault(),
            i(),
            (d = h.scrollTop()),
            f(".list-isotope,.list-isotope-metro").each(function () {
              if (
                ((e = f(this).height()),
                (g = f(this).offset().top + 50),
                f(this).find(".post-lazy-load").length &&
                  d < c &&
                  d > e + g - b)
              ) {
                var h = f(this).find(".post-lazy-load"),
                  i = f(this).find(".post-lazy-load"),
                  a = i.attr("data-page"),
                  j = i.data("total_page"),
                  k = i.data("load-class"),
                  l = i.data("layout"),
                  m = i.data("loadattr"),
                  n = i.data("offset-posts"),
                  o = i.data("display_post"),
                  p = i.data("post_load_more"),
                  q = i.html(),
                  r = i.data("loaded_posts"),
                  s = i.data("tp_loading_text");
                if (h.data("requestRunning")) return;
                if (((null == n || "" == n) && (n = 0), j > a)) {
                  h.data("requestRunning", !0);
                  var t =
                    parseInt(a - 1) * parseInt(p) + parseInt(o) + parseInt(n);
                  f.ajax({
                    type: "POST",
                    data:
                      "action=theplus_more_post&offset=" +
                    ...
                    success: function (e) {
                      if ("" == e) f(h).addClass("hide");
                      else {
                        if (
                          (f("." + k + " .post-inner-loop").append(e),
                          ("grid" == l || "masonry" == l) &&
                            !f("." + k).hasClass("list-grid-client"))
                        ) {
                          var g = f("");
                          f("." + k + " .post-inner-loop").isotope("insert", g),
                            f("." + k + " .post-inner-loop")
                              .isotope("layout")
                              .isotope("reloadItems");
                        }
                        if (
                          0 <
                          f("." + k + ".list-isotope-metro .post-inner-loop")
                            .length
                        ) {
                          var i = f("." + k),
                            m = i.data("id"),
                            n = i.attr("data-metro-columns"),
                            o = i.attr("data-metro-style");
                          theplus_backend_packery_portfolio(m, n, o),
                            f("." + k + ".list-isotope-metro .post-inner-loop")
                              .isotope("layout")
                              .isotope("reloadItems");
                        }
                        if (f("." + k).parents(".animate-general").length) {
                          var s, t;
                          if (f("." + k).find(".animated-columns").length) {
                            var u = f("." + k).parents(".animate-general"),
                              p = u.data("animate-delay"),
                              v = u.data("animate-stagger"),
                              t = u.data("animate-type"),
                              w = u.data("animate-offset");
                            ...
                            var x = f("." + k).parents(".animate-general"),
                              p = x.data("animate-delay");
                            (t = x.data("animate-type")),
                              (w = x.data("animate-offset")),
                              x.waypoint(
                      ...
                      a++,
                        a == j
                          ? (f(h).addClass("hide"),
                            f(h).attr("data-page", a),
                            f(h)
                              .parent(".ajax_lazy_load")
                              .append(
                                '<div class="plus-all-posts-loaded">' +
                                  r +
                                  "</div>"
                              ))
                          : (f(h).html(q), f(h).attr("data-page", a));
                      var b = f("." + k + " .post-inner-loop").find(
                        ".tp-audio-player-wrapper"
                      );
                      b.length &&
                        b.each(function () {
                    ...
                    complete: function () {
                      if (
                        (f("." + k + " .post-filter-data").length &&
                          f(
                            "." +
                              k +
                              " .post-filter-data .category-filters > li > a"
                          ).each(function () {
                            var a = f(this).data("filter");
                            if ("" != a && null != a && "*" === a)
                              var b = f(
                                "." + k + " .post-inner-loop .grid-item"
                              ).length;
                            else if ("" != a && null != a)
                              var b = f(
                                "." + k + " .post-inner-loop .grid-item" + a
                              ).length;
                            b && f(this).find(".all_post_count").text(b);
                          }),
                        f(
                    ...
                    if (
                      ...
                      var a = f("." + k + " .post-inner-loop");
                      a.isotope({ itemSelector: ".grid-item" });
                    }
                    if (
                      0 <
                      f("." + k + ".list-isotope-metro .post-inner-loop").length
                    ) {
                      var a = f("." + k),
                        b = a.data("id"),
                        c = a.attr("data-metro-columns"),
...
/*Carousel Anything*/ (function (a) {
  "use strict";
  var b = function (a, b) {
    b(document).ready(function () {
      var c = b(".theplus-carousel-anything-wrapper", a);
      if (c.length) {
        function a(a) {
          a.each(function () {
            var a = b(this),
              c = a.data("animate-delay"),
              e = a.data("animate-duration"),
              f = a.data("animate-type");
            a.hasClass("animation-done") ||
              a
                .addClass("animation-done")
                .velocity(f, { delay: c, duration: e, display: "auto" });
          });
        }
        var d = c.data("id");
        b("." + d + " > .post-inner-loop").on(
          "beforeChange",
          function (a, c, e, f) {
            if (e != f) {
              var g = b(".grid-item.slick-slide:not(.slick-active)").find(
                ".animate-general"
              );
              g.length &&
                g.each(function () {
                  var a = b(this);
                  a.removeClass("animation-done"), a.css("opacity", "0");
                });
            }
            if (
              "" != b("." + d).data("connection") &&
              null != b("." + d).data("connection")
            ) {
              var h = b("." + d).data("connection");
              if (
                (b("#" + h)
                  .find(
                    '.plus-accordion-header[data-tab="' + parseInt(f + 1) + '"]'
                  )
                  .hasClass("active") ||
                  b("#" + h)
                    .find(
                      '.plus-accordion-header[data-tab="' +
                        parseInt(f + 1) +
                        '"]'
                    )
                    .trigger("click"),
                b("#" + h)
                  .find(
                    'li .plus-tab-header[data-tab="' + parseInt(f + 1) + '"]'
                  )
                  .hasClass("active") ||
                  b("#" + h)
                    .find(
                    ...
                    .trigger("click"),
                b("#" + h)
                  .find('.tp-carodots-item[data-tab="' + parseInt(f) + '"]')
                  .hasClass("active") ||
                  b("#" + h)
                    .find('.tp-carodots-item[data-tab="' + parseInt(f) + '"]')
                    .trigger("click"),
                b("#" + h).find(".carousel-pagination"))
              ) {
                b("#" + h)
                  .find(
                    ".carousel-pagination ul.pagination-list li.pagination-list-in.active"
                  )
                  .html("0" + (f + 1));
              }
              if (
                !b("#" + h)
                  .find(
                    '.tp-process-steps-wrapper[data-index="' +
                      parseInt(f) +
                      '"]'
                  )
                  .hasClass("active")
              ) {
                var i = b("#" + h).data("eventtype");
                "con_pro_click" == i
                  ? b("#" + h)
                      .find(
                        '.tp-process-steps-wrapper[data-index="' +
              ...
              if (
                !b("#" + h)
                  .find(
                    '.info-box-inner[data-slick-index="' + parseInt(f) + '"]'
                  )
                  .hasClass("tp-info-active")
              ) {
                var i = b("#" + h).data("eventtype");
                "con_pro_click" == i
                  ? b("#" + h)
                      .find(
                        '.info-box-inner[data-slick-index="' +
                          parseInt(f) +
                          '"]'
                      )
                      .trigger("click")
                  : "con_pro_hover" == i &&
                    b("#" + h)
                      ...
                      .trigger("hover"),
                  b.isFunction(b.fn.plus_infobox_connection) &&
                    plus_infobox_connection(parseInt(f), h),
                  b("#" + h)
                    .find(".info-box-inner")
                    .removeClass("tp-info-active"),
                  b("#" + h)
                    .find(
                      '.info-box-inner[data-slick-index="' + parseInt(f) + '"]'
                    )
                    .addClass("tp-info-active");
              }
            }
          }
        ),
          b("." + d + " > .post-inner-loop").on("afterChange", function () {
            var c = b(".grid-item.slick-slide.slick-active").find(
              ".animate-general"
            );
            c.length && a(c);
          });
  ...
  a(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-carousel-anything.default",
      b
    );
  });
})(jQuery);
/*Cascading Image*/ function cascading_slide_show_image() {
  "use strict";
  var c = jQuery;
  c(".slide_show_image").length &&
    c(".slide_show_image").each(function () {
      var i = c(this),
        t = i.data("uid");
      c("." + t);
      c("." + t + ".slide_show_image .cascading-image:last").addClass("active");
      var s = i.find(".cascading-image"),
        n = i.data("play");
      c("." + t + " .cascading-image").each(function () {
        var e = c(this);
        if ("onclick" == n)
          e.on("click", function () {
            if (!s.last().is(e))
              return (
                e.addClass("out").animate({ opacity: 0.7 }, 200, function () {
                  e.detach(),
                    e
                      .insertAfter(s.last())
                    ...
                    (s = i.find(".cascading-image")).removeClass("active"),
                    e.addClass("active");
                }),
                !1
              );
          ...
          var a = c("." + t).data("interval_time");
          setInterval(function () {
            var e = c(
                "." + t + ".slide_show_image .cascading-image.active"
              ).removeClass("active"),
              a = e.next().length ? e.next() : e.siblings().filter(":first");
            if ((a.addClass("active"), !s.last().is(a)))
              return (
                a.addClass("out").animate({ opacity: 0.7 }, 200, function () {
                  a.detach(),
                    a
                      .insertAfter(s.last())
                      .animate({ opacity: 1 }, 500, function () {
...
function cascading_overflow() {
  "use strict";
  var n = jQuery;
  n(".cascading-block").length &&
    n(".cascading-block").each(function () {
      var e = window.innerWidth,
        a = n(this),
        i = n(this).data("overflow-desktop"),
        t = n(this).data("overflow-tablet"),
        s = n(this).data("overflow-mobile");
      "yes" == i && 991 < e
        ? a.closest("section.elementor-element").css("overflow", "hidden")
        : "yes" == t && e <= 991 && 600 < e
        ? a.closest("section.elementor-element").css("overflow", "hidden")
        : "yes" == s && e <= 600
        ? a.closest("section.elementor-element").css("overflow", "hidden")
        : a.closest("section.elementor-element").css("overflow", "visible");
    });
}
!(function (e) {
  "use strict";
  e(document).ready(function () {
    cascading_slide_show_image(), cascading_overflow();
  }),
    e(window).on("load resize", function () {
      cascading_overflow();
    });
})(jQuery);
/*Process Steps*/ (function (a) {
  "use strict";
  var b = function (a, b) {
    var c = a.find(".tp-process-steps-widget"),
      d = c.find(".tp-process-steps-wrapper"),
      e = c.data("connection"),
      f = c.data("eventtype");
    if (c.hasClass("style_2")) {
      var g = b(window).innerWidth();
      if (768 <= g) {
        var h = d.length,
          i = c.width(),
          j = i - 20 * h,
    ...
    "" != e &&
      ...
      ("" != e && "con_pro_hover" == f
        ? d.on("mouseenter", function () {
            b(this)
              .closest(".tp-process-steps-widget")
              .find(".tp-process-steps-wrapper")
              .removeClass("active"),
            ...
            if ("" != a && a != null) {
              var c = b(this).index();
              plus_process_step_connection(parseInt(c), a);
            }
          })
        : "" != e &&
          "con_pro_click" == f &&
  ...
  a(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-process-steps.default",
      b
    );
  });
})(jQuery);
function plus_process_step_connection(a, b) {
  "use strict";
  var c = jQuery;
  if ("" != b && 0 < c("." + b).length) {
    var d = c("." + b + " > .post-inner-loop").slick("slickCurrentSlide");
    d != a && c("." + b + " > .post-inner-loop").slick("slickGoTo", a);
  }
} /*DataTables (1.10.19)*/
(function (h) {
  "function" === typeof define && define.amd
...
/*DataTable*/ (function (a) {
  "use strict";
  var b = function (b, c) {
    function a() {
      767 < c(window).width()
        ? (c(f).addClass("plus-column-rules"),
          c(f).removeClass("plus-no-column-rules"))
        : (c(f).removeClass("plus-column-rules"),
          c(f).addClass("plus-no-column-rules"));
    }
    if (void 0 !== b) {
      b.find(".plus-table-wrapper");
      var e = b.data("id"),
        f = b.find(".plus-table"),
        g = b.find("#plus-table-id-" + e),
        h = !1,
        j = !1,
        k = !1;
      if (0 != g.length) {
        "yes" ==
          c(".elementor-element-" + e + " #" + g[0].id).data("searchable") &&
          (h = !0),
          "yes" ==
            c(".elementor-element-" + e + " #" + g[0].id).data("show-entry") &&
            (j = !0),
          "yes" ==
            c(".elementor-element-" + e + " #" + g[0].id).data("sort-table") &&
            (c(".elementor-element-" + e + " #" + g[0].id + " th").css({
              cursor: "pointer",
            }),
            (k = !0));
        var l = c(".elementor-element-" + e + " #" + g[0].id).data(
          "searchable-label"
        );
        (h || j || k) &&
          (c("#" + g[0].id).DataTable({
          ...
          b
            ...
            .addClass("plus-tbl-entry-wrapper plus-table-info"),
          b
            .find(".dataTables_filter")
            .addClass("plus-tbl-search-wrapper plus-table-info"),
          b
            .find(".plus-table-info")
            .wrapAll('<div class="plus-advance-heading"></div>')),
  ...
  a(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-table.default",
      b
    );
  });
})(jQuery);
/*tabs & tours*/ (function (a) {
  "use strict";
  var b = function (a, b) {
    var c = a.find(".theplus-tabs-wrapper"),
      d = c.data("tab-hover"),
      f = "#" + c.attr("id").toString();
    b(f + " ul.plus-tabs-nav li .plus-tab-header").each(function (a) {
      var c = b(this).closest(".theplus-tabs-wrapper").data("tab-default");
      if (c == a) {
        b(this).removeClass("inactive").addClass("active");
        var d = b(this).closest(".theplus-tabs-wrapper").data("connection");
        "" != d &&
          d != null &&
          b("." + d).length &&
          setTimeout(function () {
            plus_tabs_connection(parseInt(c + 1), d);
          }, 150);
        var e = b(this).closest(".theplus-tabs-wrapper").data("row-bg-conn");
        "" != e &&
          e != null &&
          b("#" + e).length &&
          background_accordion_tabs_conn(c + 1, e);
      }
    }),
      b(f + " .theplus-tabs-content-wrapper .plus-tab-content").each(function (
        a
      ) {
        var c = b(this).closest(".theplus-tabs-wrapper").data("tab-default");
        c == a &&
          (b(this).removeClass("inactive").addClass("active"),
          (b(f + " .list-isotope-metro .post-inner-loop").length ||
            b(f + " .list-isotope .post-inner-loop").length) &&
            setTimeout(function () {
              b(
                f + " .list-isotope-metro .post-inner-loop",
                f + " .list-isotope .post-inner-loop"
              ).isotope("layout");
            }, 10));
      }),
      "no" == d &&
        b(f + " ul.plus-tabs-nav li .plus-tab-header").on("click", function () {
          var a = b(this).data("tab"),
            c = b(this).closest(".theplus-tabs-wrapper"),
            d = b(c)
              .children("ul.plus-tabs-nav")
              .children("li")
              .children(".plus-tab-header"),
            e = b(c)
              .children(".theplus-tabs-content-wrapper")
              .children(".plus-tab-content");
          b(c)
            .find(">.theplus-tabs-nav-wrapper .plus-tab-header")
            .removeClass("active default-active")
            .addClass("inactive"),
            b(this).addClass("active").removeClass("inactive"),
            b(c)
              .find(">.theplus-tabs-content-wrapper>.plus-tab-content")
              .removeClass("active")
              .addClass("inactive"),
            b(
              ">.theplus-tabs-content-wrapper>.plus-tab-content[data-tab='" +
                a +
                "']",
              c
            )
            ...
            b(e).each(function () {
              b(this).removeClass("default-active");
            }),
            b(
              ">.theplus-tabs-content-wrapper>.plus-tab-content[data-tab='" +
                a +
              ...
              c
            ).length && size_Elements();
          var g = b(this).closest(".theplus-tabs-wrapper").data("connection");
          if ("" != g && null != g && b("." + g).length) {
            var h = b(this).data("tab");
            plus_tabs_connection(h, g);
          }
          var i = b(this).closest(".theplus-tabs-wrapper").data("row-bg-conn");
          if ("" != i && null != i && b("#" + i).length) {
            var h = b(this).data("tab");
            background_accordion_tabs_conn(h, i);
          }
          if (
            (b(f + " .list-carousel-slick > .post-inner-loop").length &&
              b(f + " .list-carousel-slick > .post-inner-loop").slick(
                "setPosition"
              ),
            b(f + " .elementor-background-video-embed").length &&
              setTimeout(function () {
                var d = b(".theplus-tabs-content-wrapper", c)
                    .find(
                      "[data-tab='" + a + "'] .elementor-background-video-embed"
                    )
                    .closest(".elementor-background-video-container")
                    .outerWidth(),
                  e = b(".theplus-tabs-content-wrapper", c)
                    .find(
                      "[data-tab='" + a + "'] .elementor-background-video-embed"
                    )
                    .closest(".elementor-background-video-container")
                  ...
                  l = i ? d / j : e;
                100 == l && ((k = "100%"), (l = "100%")),
                  b(f + " .elementor-background-video-embed")
                    .width(k)
                    .height(l);
              }, 50),
            b(f + " iframe.pt-plus-bg-video").length &&
              setTimeout(function () {
                var a = b(f + " iframe.pt-plus-bg-video")
                    .closest(".columns-video-bg")
                    .outerWidth(),
                  c = b(f + " iframe.pt-plus-bg-video")
                    .closest(".columns-video-bg")
                    .outerHeight(),
                  d = ["16", "9"],
                  e = d[0] / d[1],
                  ...
                  i = g ? a : c * e,
                  j = g ? a / e : c;
                b(f + " iframe.pt-plus-bg-video")
                  .width(i)
                  .height(j);
              }, 100),
            b(
              f +
                " .plus-tab-content[data-tab='" +
                a +
                "'] .list-isotope-metro .post-inner-loop"
            ).length)
          ) {
            var j = b(
                f +
              ...
              k = j.data("id"),
              l = j.attr("data-metro-columns"),
              m = j.attr("data-metro-style");
            theplus_backend_packery_portfolio(k, l, m),
              b(
                f +
                  " .plus-tab-content[data-tab='" +
                  a +
          ...
          if (
            ...
            b(f + " .plus-tab-content[data-tab='" + a + "'] .tp-unfold-wrapper")
              .length)
          ) {
            var n = b(
                f +
            ...
            n <= o
              ? (b(
                  f +
                    " .plus-tab-content[data-tab='" +
                    a +
                    "'] .tp-unfold-last-toggle"
                ).css("display", "none"),
                b(
                  f +
                    " .plus-tab-content[data-tab='" +
                    a +
                    "'] .tp-unfold-description"
                ).append(
                  "<style>.tp-unfold-wrapper." +
                    p +
                    " .tp-unfold-description:after{min-height:0 !important;}</style>"
                ))
              : b(
                  f +
                    " .plus-tab-content[data-tab='" +
      ...
      "yes" == d &&
        b(f + " ul.plus-tabs-nav li .plus-tab-header").mouseover(function () {
          var a = b(this).data("tab"),
            c = b(this).closest(".theplus-tabs-wrapper"),
            d = b(c)
              .children("ul.plus-tabs-nav")
      ...
      0 < b(".theplus-tabs-wrapper.swiper-container").length &&
        new Swiper(".theplus-tabs-wrapper.swiper-container", {
          slidesPerView: "auto",
          mousewheelControl: !0,
          freeMode: !0,
        }),
      b(f).hasClass("mobile-accordion") &&
        (b(window).on("resize", function () {
          600 >= b(window).innerWidth() &&
            b(f).addClass("mobile-accordion-tab");
        }),
        b(f + " .theplus-tabs-content-wrapper .elementor-tab-mobile-title").on(
          "click",
          function () {
            var a = b(this).data("tab"),
              c = b(this).closest(".theplus-tabs-wrapper"),
              d = b(c)
                .children(".theplus-tabs-content-wrapper")
                .children(".elementor-tab-mobile-title"),
              e = b(c)
                .children(".theplus-tabs-content-wrapper")
                .children(".plus-tab-content");
            b(c)
              .find(
                ">.theplus-tabs-content-wrapper .elementor-tab-mobile-title"
              )
              .removeClass("active default-active")
              .addClass("inactive"),
              b(this).addClass("active").removeClass("inactive"),
    ...
    if ("" != g && g != null && !b(g).hasClass("active") && b(g).length) {
      b("html, body").animate({ scrollTop: b(g).offset().top }, 1500),
        b(g + ".plus-tab-header").trigger("click");
      var h = b(g).data("tab");
      b(".elementor-tab-mobile-title[data-tab='" + h + "']").trigger("click");
    }
  };
  a(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-tabs-tours.default",
      b
    );
  });
})(jQuery);
function plus_tabs_connection(a, b) {
  var c = jQuery;
  if ("" != b && 1 == c("." + b).length) {
    var d = c("." + b + " > .post-inner-loop").slick("slickCurrentSlide");
    d != a - 1 && c("." + b + " > .post-inner-loop").slick("slickGoTo", a - 1);
...
!(function (e, t) {
  ...
  function n(e) {
    ...
    return (
      I && e.length
        ? (e.one(I, t.resolve), setTimeout(t.resolve, 500))
        : t.resolve(),
      t.promise()
    );
  }
  ...
  function r(e) {
    ...
    for (
      ...
      i[o] && (r[(n = i[o].split("="))[0]] = n[1]);
    return r;
  }
  function o(e, n) {
    if (!n) return e;
    if (("string" === t.type(n) && (n = r(n)), e.indexOf("?") > -1)) {
      var i = e.split("?");
      (e = i.shift()), (n = t.extend({}, r(i[0]), n));
    }
    return e + "?" + t.param(n);
  }
  function a(e, t) {
  ...
  function l(e, t, n, i) {
    return (
      t && t.element().addClass("lity-iframe"),
      n && (e = o(e, n)),
      i && (e = a(i, e)),
  ...
  function h(e) {
    1 === D.unshift(e) &&
      (E.addClass("lity-active"), j.on({ resize: v, keydown: y })),
      t("body > *")
        .not(e.element())
        .addClass("lity-hidden")
        .each(function () {
          var e = t(this);
          void 0 === e.data(T) && e.data(T, e.attr(z) || null);
        })
        .attr(z, "true");
  }
  function m(e) {
    e.element().attr(z, "true"),
      1 === D.length &&
        (E.removeClass("lity-active"), j.off({ resize: v, keydown: y })),
      ((D = t.grep(D, function (t) {
        ...
        .each(function () {
          var e = t(this),
            n = e.data(T);
          n ? e.attr(z, n) : e.removeAttr(z), e.removeData(T);
        });
  }
  function g() {
  ...
  function x(e, r, o, a) {
    function l(e) {
      (c = t(e).css("max-height", f() + "px")),
        ...
        jQuery(".list-isotope").length &&
          jQuery(".list-isotope")
            .find(".post-inner-loop")
            .isotope("layout")
            .isotope("reloadItems"),
        jQuery(".list-isotope-metro").length > 0 &&
    ...
    (r = t.extend({}, Q, r)),
      ...
      (u.options = t.proxy(i, u, r)),
      (u.handlers = t.proxy(i, u, r.handlers)),
      (u.resize = function () {
        y && !p && c.css("max-height", f() + "px").trigger("lity:resize", [u]);
      }),
      (u.close = function () {
        if (y && !p) {
          (p = !0), m(u);
          ...
          if (
            a &&
            (C.activeElement === d[0] || t.contains(d[0], C.activeElement))
          )
            try {
              a.focus();
            } catch (e) {}
      ...
      (s = b(e, u, r.handlers, r.handler)),
      t("body").addClass("opened-lity-popup " + u.opener().data("lity-uid")),
      d
        .attr(z, "false")
        .addClass("lity-loading lity-opened lity-" + s.handler)
        .appendTo("body")
        .focus()
        .on("click", "[data-lity-close]", function (e) {
          t(e.target).is("[data-lity-close]") &&
            (t("body").removeClass(
              "opened-lity-popup " + u.opener().data("lity-uid")
            ),
            u.close());
        })
        .trigger("lity:open", [u]),
      h(u),
      t.when(s.content).always(l);
  }
  function w(e, n, i) {
    e.preventDefault
      ? (e.preventDefault(),
        (e =
          (i = t(this)).data("lity-target") || i.attr("href") || i.attr("src")))
      : (i = t(i));
    var r = new x(
      e,
  ...
  var C = e.document,
    ...
    Q = {
      esc: !0,
      handler: null,
      handlers: { image: d, inline: c, iframe: u },
      template:
  ...
  return (
    ...
    (w.version = "3.0.0-dev"),
    (w.options = t.proxy(i, w, Q)),
    (w.handlers = t.proxy(i, w, Q.handlers)),
    (w.current = g),
    (w.iframe = l),
    t(C).on("click.lity", "[data-lity]", w),
    w
  );
});
!(function (e, t) {
...
function initFluidVids() {
  "use strict";
  fluidvids.init({
    selector: ["iframe:not(.pt-plus-bg-video)"],
    players: ["www.youtube.com", "player.vimeo.com"],
  });
}
!(function (t) {
  ...
  t("iframe").length &&
    ...
    t("body").on("post-load", initFluidVids));
})(jQuery),
  (function (d) {
    "use strict";
    function i(t) {
      var e = t.find("video"),
        i = t.find(".ts-video-lazyload");
      if (
        (t.is("[data-grow]") && t.css("max-width", "none"),
        t
          .find(
            ".ts-video-title, .ts-video-description, .ts-video-play-btn, .ts-video-thumbnail"
          )
          .addClass("ts-video-hidden"),
        i.length)
      ) {
        var n = i.data();
        d("<iframe></iframe>").attr(n).insertAfter(i);
      }
      e.length && e.get(0).play();
    }
    function t() {
      d(".ts-video-wrapper[data-inview-lazyload]").one(
        "inview",
        function (t, e) {
          e && i(d(this));
        }
    ...
    d(document).on(
      "click",
      '[data-mode="lazyload"] .ts-video-play-btn',
      function (t) {
        t.preventDefault(), i(d(this).closest(".ts-video-wrapper"));
      }
    ),
      t(),
      ...
      d(document).on("lity:open", function () {}),
      d(document).on("lity:ready", function (t, e) {
        var i = e.element(),
          n = i.find("video"),
          o = i.find(".ts-video-lazyload");
        d(".lity-wrap").attr("id", "ts-video"),
          o.length && d("<iframe></iframe>").attr(o.data()).insertAfter(o),
          n.length && n.get(0).play();
      }),
      d(document).on("lity:close", function (t, e) {
        e.element().find("video").length &&
          e.element().find("video").get(0).pause(),
          d(".ts-video-lity-container .pt-plus-video-frame").remove(),
          d("[data-hidden-fixed]").removeClass("ts-video-hidden");
      }),
      d(document).ready(function () {
        d(".ts-video-lightbox-link").off();
      });
  })(jQuery);
/*unfold*/ (function (a) {
  "use strict";
  var b = function (a, b) {
    var c = a.find(".tp-unfold-wrapper"),
      d = c.data("id"),
      e = c.data("icon-position"),
      f = c.data("readmore"),
      g = c.data("readless"),
      h = c.data("readmore-icon"),
      i = c.data("readless-icon"),
      j = c.data("content-max-height"),
      k = c.data("content-max-height-m"),
      l = c.data("content-max-height-t"),
      m = c.data("transition-duration"),
      n = c.find(".tp-unfold-toggle");
    if (c.length) {
      var o = c
        .find(".tp-unfold-description .tp-unfold-description-inner")
        .outerHeight();
      o <= j
        ? (c.find(".tp-unfold-last-toggle").css("display", "none"),
          c
            .find(".tp-unfold-description")
            .append(
              "<style>.tp-unfold-wrapper." +
                d +
                " .tp-unfold-description:after{min-height:0 !important;}</style>"
            ))
        : c.find(".tp-unfold-last-toggle").css("display", "flex"),
        n.on("click", function () {
          var a = b(this)
              .closest(".tp-unfold-wrapper")
              .find(".tp-unfold-toggle"),
            d = b(this)
              .closest(".tp-unfold-wrapper")
              .find(".tp-unfold-description");
          if (
            (b(this).closest(".tp-unfold-wrapper").toggleClass("fullview"),
            b(this).closest(".tp-unfold-wrapper").hasClass("fullview"))
          ) {
            var n = parseInt(
              b(this)
                .closest(".tp-unfold-wrapper")
                .find(".tp-unfold-description-inner")
                .outerHeight()
            );
            "tp_ic_pos_before" == e && null != e
              ? a.html(i + g)
              : "tp_ic_pos_after" == e && null != e && a.html(g + i),
              d.animate({ height: n }, m);
          } else {
            "tp_ic_pos_before" == e && null != e
              ? a.html(h + f)
              : "tp_ic_pos_after" == e && null != e && a.html(f + h);
            var o = b(window).innerWidth();
            1025 <= o
              ? d.animate({ height: j }, m)
              : 1024 >= o && 768 <= o
              ? d.animate({ height: l }, m)
              : 767 >= o && d.animate({ height: k }, m);
          }
          c.closest(".post-inner-loop").length &&
            setTimeout(function () {
              c.closest(".post-inner-loop").isotope("layout");
            }, m - 20);
        });
    }
  };
  a(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-unfold.default",
      b
    );
  });
})(jQuery);
