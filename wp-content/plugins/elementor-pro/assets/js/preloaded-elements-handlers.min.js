      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.default = function addDocumentHandle(e) {
          ...
          const m = (function createHandleElement(e, t) {
                ...
                createElement({
                  ...
                  children: [
                    document.createTextNode(
                      r === t
                        ? s("Edit %s", "elementor-pro").replace("%s", n)
            ...
            return l.addEventListener("click", o), l;
          })(
            {
              title: l,
              onClick: () =>
    ...
    9318: (e, t, n) => {
      ...
      class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
        ...
        setContentContainerAbsolutePosition(e) {
          ...
          if ((0, s.isMenuInDropdownMode)(t)) return;
          if (n) {
            const t = elementorFrontend.config.is_rtl ? "right" : "left",
              n = this.getMenuItemContainerAbsolutePosition(e);
            this.elements.$menuContent.css(t, n);
          }
          const i =
            this.elements.$headingContainer[0].getBoundingClientRect().height;
          if (this.shouldPositionContentAbove(e, i)) {
        ...
        getMenuItemContainerAbsolutePosition(e) {
          ...
          return (i -= this.getMenuContainerOffset()), i;
        }
        ...
        isMobileDevice() {
          if (void 0 !== elementorFrontend.utils.environment.isTouchDevice)
      ...
      class StretchedMenuItemContent extends elementorModules.frontend.handlers
        ...
        stretch() {
          this.isStretchSettingEnabled() &&
            (!this.$element.hasClass("e-fit_to_content") ||
            (0, s.isMenuInDropdownMode)(this.getElementSettings())
      ...
      var i = s(n(2298)),
        o = i.default.extend({
          ...
          arrangeGrid() {
            ...
            d.each(function () {
              var n = e(this),
                s = t.getOffset(l.index(n), c, h),
                i = t.getOffset(a.index(n), c, h);
              ...
              setTimeout(function () {
                s.each(function () {
                  var i = e(this),
                    o = t.getOffset(l.index(i), c, h),
                    r = t.getOffset(s.index(i), c, h);
      ...
      var n = elementorModules.frontend.handlers.Base.extend({
        ...
        bindEvents() {
          ...
          const toggleFullScreenSearch = () => {
            t.toggleClass(l.isFullScreen).toggleClass(l.lightbox),
              s.trigger("focus");
          };
          "full_screen" === a
            ? (r.on("click", function () {
            ...
            .forEach((t) => {
              ...
              (o.breakpoints[s[t].value] = {
                ...
                e.image_spacing_custom &&
                  (o.breakpoints[s[t].value].spaceBetween =
