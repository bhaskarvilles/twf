            ...
            .forEach((t) => {
              ...
              (o.breakpoints[i[t].value] = {
                ...
                e.image_spacing_custom &&
                  (o.breakpoints[i[t].value].spaceBetween =
                    this.getSpaceBetween(t)),
                (r = +e["slides_to_show_" + t] || s);
            }),
            "yes" === e.autoplay &&
              (o.autoplay = {
      ...
      class Video extends elementorModules.frontend.handlers.Base {
        ...
        prepareYTVideo(e, t) {
          ...
          s.yt_privacy &&
            ...
            (this.youtubePlayer = new e.Player(this.elements.$video[0], i));
        }
        bindEvents() {
    ...
    4508: (e, t, s) => {
      ...
      class IconsManager {
        ...
        createSvgElement(e, t) {
          ...
          return this.createSvgIconElement({ iconName: o, iconSelector: r });
        }
        createSvgNode(e, t) {
          let { props: s = {}, attrs: i = {} } = t;
          const n = document.createElementNS("http://www.w3.org/2000/svg", e);
          return (
            Object.keys(s).map((e) => (n[e] = s[e])),
            Object.keys(i).map((e) => n.setAttributeNS(null, e, i[e])),
            n
          );
        }
        createSvgIconElement(e) {
          let { iconName: t, iconSelector: s } = e;
          return this.createSvgNode("svg", {
            props: { innerHTML: '<use xlink:href="' + s + '" />' },
        ...
        createSymbolElement(e) {
          let { id: t, path: s, width: i, height: n } = e;
          return this.createSvgNode("symbol", {
            props: { innerHTML: '<path d="' + s + '"></path>', id: t },
            attrs: { viewBox: "0 0 " + i + " " + n },
          });
        }
      }
      (t.default = IconsManager),
        (0, n.default)(IconsManager, "symbolsContainer", void 0),
        (0, n.default)(IconsManager, "iconsUsageList", []);
    },
    3896: (e, t, s) => {
      "use strict";
      var i = s(3203)(s(3251)),
      ...
      e.exports = elementorModules.ViewModule.extend({
          ...
          switch (
            ...
            (n.onHide = function () {
              DialogsManager.getWidgetType("lightbox").prototype.onHide.apply(
                ...
                i.default.isFullscreen && t.deactivateFullscreen(),
                t.unbindHotKeys();
            }),
            e.type)
          ) {
        ...
        setVideoContent(e) {
          ...
          if ("hosted" === e.videoType) {
            const i = t.extend({ src: e.url, autoplay: "" }, e.videoParams);
            s = t("<video>", i);
          } else {
            let i;
            if (-1 !== e.url.indexOf("vimeo.com"))
              i = elementorFrontend.utils.vimeo;
            else {
              if (
                !e.url.match(
          ...
          const i = this.getSettings("classes"),
            n = t("<div>", { class: `${i.videoContainer} ${i.preventClose}` }),
            o = t("<div>", { class: i.videoWrapper });
        ...
        getShareLinks() {
          const { i18n: e } = elementorFrontend.config,
            t = {
              facebook: { label: e.shareOnFacebook, iconElement: n.facebook },
              twitter: { label: e.shareOnTwitter, iconElement: n.twitter },
              pinterest: { label: e.pinIt, iconElement: n.pinterest },
            },
            s = jQuery,
            i = this.getSettings("classes"),
            o = this.getSettings("selectors"),
            r = s("<div>", { class: i.slideshow.shareLinks }),
        ...
        createShareLink(e, t) {
          ...
          return (
            "pinterest" === e
              ? (i.image = encodeURIComponent(t))
              : (i.url = encodeURIComponent(
                  location.href.replace(/#.*/, "") + s
                )),
            ShareLink.getNetworkLink(e, i)
          );
        },
        getSlideshowHeader() {
          const { i18n: e } = elementorFrontend.config,
          ...
          if (s || i || o || r) {
            if (
              ...
              i.on("click", (e) => {
                ...
                (d.$shareMenu = t("<div>", { class: l.shareMenu }).append(i)),
                d.$iconShare
                  .add(d.$shareMenu)
            ...
            if (o) {
              const s = this.isFontIconSvgExperiment
                ...
                r = { ...o };
              this.isFontIconSvgExperiment || (r.class = l.iconZoomIn),
                (d.$iconZoom = t(s).attr(r).on("click", this.toggleZoomMode)),
                i.push(d.$iconZoom),
                this.isFontIconSvgExperiment &&
                  ((d.$iconZoomOut = t(n.zoomOutBold.element)
                    .attr(o)
                    .addClass(a.hidden)
                    .on("click", this.toggleZoomMode)),
                  i.push(d.$iconZoomOut)),
                d.$header.append(i),
                (this.$buttons = this.$buttons.add(i));
            }
            if (i) {
              const s = this.isFontIconSvgExperiment
                  ? n.frameExpand.element
                  : "<i>",
                i = [],
                o = {
                  role: "switch",
                ...
                r = { ...o };
              this.isFontIconSvgExperiment || (r.class = l.iconExpand),
                (d.$iconExpand = t(s)
                ...
                i.push(d.$iconExpand),
                this.isFontIconSvgExperiment &&
                  ((d.$iconMinimize = t(n.frameMinimize.element)
                    .attr(o)
                    .addClass(a.hidden)
                    .on("click", this.toggleFullscreen)),
                  i.push(d.$iconMinimize)),
                d.$header.append(i),
                (this.$buttons = this.$buttons.add(i));
            }
            return (
        ...
        toggleFullscreen() {
          i.default.isFullscreen
            ? this.deactivateFullscreen()
            : i.default.isEnabled && this.activateFullscreen();
        },
        toggleZoomMode() {
          ...
          if (
            (e.slides.forEach((e) => {
              ...
              if (e.video) {
                ...
                e.title && ((n["data-title"] = e.title), (n.alt = e.title)),
                  e.description &&
                    ((n["data-description"] = e.description),
                    (n.alt += " - " + e.description));
                const r = s("<img>", n);
            ...
            const e = this.isFontIconSvgExperiment
                ? s(n.chevronLeft.element)
                : s("<i>", { class: d.prevButtonIcon }),
              i = this.isFontIconSvgExperiment
                ? s(n.chevronRight.element)
            ...
            (u = s("<div>", {
              ...
              c.append(p, u),
              (this.$buttons = this.$buttons.add(p).add(u));
          }
          a &&
          ...
          if (9 === e.which) {
            ...
            t.each((e) => {
              ...
              if (jQuery(o).is(":focus"))
                return (s = o), (i = 0 === e), (n = t.length - 1 === e), !1;
            }),
              e.shiftKey
                ? i && (e.preventDefault(), t.last().trigger("focus"))
                : (!n && s) || (e.preventDefault(), t.first().trigger("focus"));
          }
        },
        ...
        playSlideVideo() {
          ...
          i.append(n),
            ...
            -1 !== t.indexOf("vimeo.com")
              ? ((r = "vimeo"), (a = elementorFrontend.utils.vimeo))
              : t.match(
                  /^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/
                ) && ((r = "youtube"), (a = elementorFrontend.utils.youtube));
          const l = a.getVideoIDFromURL(t);
          a.onApiReady((e) => {
            "youtube" === r
              ? this.prepareYTVideo(e, l, i, n, o)
              : "vimeo" === r && this.prepareVimeoVideo(e, t, i, n, o);
          }),
        ...
        prepareVimeoVideo(e, t, s, i, n) {
          const o = this.getSettings("classes"),
            r = { url: t, autoplay: !0, transparent: !1, playsinline: !1 };
          (this.player = new e.Player(i, r)),
        ...
        openSlideshow(e, t) {
          ...
          s.each(function () {
            ...
            this.showModal({
              ...
              slideshow: { slides: i, swiper: { initialSlide: +n } },
            });
        },
        onSlideChange() {
          this.getSlide("prev")
      ...
      !(function () {
              ...
              return new Promise(
                function (s, n) {
                  ...
                  this.on("change", o),
                    ...
                    Promise.resolve(e[i.requestFullscreen]()).catch(n);
                }.bind(this)
              );
            },
            exit() {
              return new Promise(
                function (e, s) {
                  if (this.isFullscreen) {
                    ...
                    this.on("change", n),
                      Promise.resolve(t[i.exitFullscreen]()).catch(s);
                  } else e();
                }.bind(this)
              );
            },
        ...
        i
          ? (Object.defineProperties(o, {
              ...
              element: { enumerable: !0, get: () => t[i.fullscreenElement] },
              isEnabled: {
                enumerable: !0,
